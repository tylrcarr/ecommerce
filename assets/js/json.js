/*
 * this would be back end, but there is no backend. 
 * oh well.
 */
...
const pitchforks = {
	"0" : {
		...
		"reviews": [
			{
				"name": "Jethro Millikan",
				"text": "After switchin to this fork, I increased my hay production by 50%. [unintelligible] best fork there is."
			},
			{
				"name": "Dr. Frankenstein",
				"text": "That mob thought they had the upperhand, but little did they know I had this fork. Best defense weapon out there."
			},
			{
				"name": "Napoleon Bonaparte",
				"text": "We thought swords were ze way when on attack, but this Pitchfork really helped ze infantrymen do zeir work. 10/10 recommend."
			}
		],
		"ratings": {
			"portability" : 3,
		...
		"reviews": [
			{
				...
				"text": "Best home defense weapon I've ever owned. Really stops those thiefs right in their place."
			},
			{
				"name": "Shaquem Griffin",
				"text": "0/10 do not recommend. There was no disclaimer telling me I have to use two hands with this fork."
			},
			{
				"name": "Michael Phelps",
				"text": "Works perfectly, especially because my back is so strong compared to my arms."
			}
		],
		"ratings": {
			"portability" : 2,
